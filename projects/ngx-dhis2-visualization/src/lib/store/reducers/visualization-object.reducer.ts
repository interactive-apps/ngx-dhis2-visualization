...
export function visualizationObjectReducer(state: VisualizationObjectState = initialState,
  action: VisualizationObjectAction): VisualizationObjectState {
  switch (action.type) {
    ...
    case VisualizationObjectActionTypes.ADD_VISUALIZATION_OBJECT:
      return visualizationObjectAdapter.addOne(action.visualizationObject, state);
